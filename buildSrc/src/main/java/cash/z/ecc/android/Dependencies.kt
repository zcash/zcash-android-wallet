...
object Deps {
    ...
    const val versionName =         "1.0.0-alpha70"
    const val versionCode =         1_00_00_170  // last digits are alpha(0XX) beta(2XX) rc(4XX) release(8XX). Ex: 1_08_04_401 is an release candidate build of version 1.8.4 and 1_08_04_800 would be the final release.
    ...
    object AndroidX {
        ...
        object CameraX :         Version("1.1.0-alpha04") {
        ...
        object Lifecycle :       Version("2.4.0-alpha01") {
    ...
    object Analytics { // for dogfooding/crash-reporting/feedback only on internal team builds
        val BUGSNAG =                       "com.bugsnag:bugsnag-android:5.9.2"
    ...
    object Zcash {
        ...
        const val SDK =                      "cash.z.ecc.android:zcash-android-sdk:1.3.0-beta12"
    }
    object Misc {
    ...
    object Test {
        ...
        const val MOKITO =                   "org.mockito:mockito-android:3.10.0"
        ...
        object Android {
            ...
            const val ESPRESSO =             "androidx.test.espresso:espresso-core:3.4.0-alpha06"
        }
    }
}
